...
nordpool_df = pd.read_csv(nordpool_fails, sep=';')

# Pārdēvēt kolonnas
nordpool_df.columns = ['ts_start', 'ts_end', 'price']

# Konvertēt 'ts_start' uz datetime formātu
nordpool_df['Datums_Stunda'] = pd.to_datetime(nordpool_df['ts_start'], format='%Y-%m-%d %H:%M:%S')
...
apvienoti_df['Izmaksas'] = apvienoti_df['Patēriņš'] * apvienoti_df['price']
